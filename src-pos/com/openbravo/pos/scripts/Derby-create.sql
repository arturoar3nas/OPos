...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'Tasa 1');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('002', 'Tasa 2');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('003', 'Tasa 3');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'Tasa 1', '001', NULL, NULL, 0.07, 0, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('002', 'Tasa 2', '002', NULL, NULL, 0.10, 0, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('003', 'Tasa 3', '003', NULL, NULL, 0.15, 0, NULL);
...
CREATE TABLE MAQUINA(
   ...
   ID_ULTFACTURA INTEGER NOT NULL,
   ID_ULTINC INTEGER NOT NULL,
   FECHA TIMESTAMP NOT NULL,
   OBSERVACIONES VARCHAR(1024) NOT NULL,
   PRIMARY KEY(ID)
);

CREATE TABLE MAQUINA_TAXES(
    MAQUINA VARCHAR(256) NOT NULL,
    TASA VARCHAR(256) NOT NULL,
    CONSTRAINT MAQ_TAX_FK_1 FOREIGN KEY (MAQUINA) REFERENCES MAQUINA(ID),
    CONSTRAINT MAQ_TAX_FK_2 FOREIGN KEY (TASA) REFERENCES TAXES(ID)
);
